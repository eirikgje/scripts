...
m = hp.ma(hp.read_map("chisq_c0001_k00200.fits", 0))
...
for width in [18., 12., 8.8]:
    for cmap, colormaptag in [(None, ''), (colombi1_cmap, "colombi1_")]:
        ...
        plt.grid(True)
        plt.savefig("commander_chisq_map_" + colormaptag + "python_%dmm.pdf" % int(width*10), bbox_inches='tight', pad_inches=0.02)
#        plt.savefig("commander_chisq_map_" + colormaptag + "python_%dmm.png" % int(width*10), bbox_inches='tight', pad_inches=0.02)
